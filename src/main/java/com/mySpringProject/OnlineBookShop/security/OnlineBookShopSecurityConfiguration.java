...
@Profile("!test")
public class OnlineBookShopSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    AuthenticationProvider authenticationProvider() {
        ...
        UserDetailsServiceImpl detailsService = new UserDetailsServiceImpl(userEntityRepository, config);
